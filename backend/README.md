...
AgroSaldo Backend API - Sistema de gestão pecuária com NestJS, PostgreSQL e Prisma.
...
│   ├── dto/           # DTOs compartilhados (PaginationDto)
...
✅ **Arquitetura Modular**: Cada domínio em seu próprio módulo
✅ **DTOs**: Validação com class-validator
✅ **Entities**: Separação de modelos de domínio
...
✅ **Pipes**: Validação customizada (UUID, etc)
✅ **Config**: Configuração centralizada por ambiente
